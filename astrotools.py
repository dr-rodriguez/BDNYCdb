...
def filter_info(band):
  ...
  *band*
  ...
  Filters = { "U":      { 'eff': 0.357065, 'min': 0.303125, 'max': 0.417368, 'zp': 3.698499e-09, 'zp_photon': 6.5743e+02, 'ABtoVega':0, 'ext': 1.56, 'system': 'Bessel' }, 
              ...
              "L'":     { 'eff': 3.73221,  'min': 3.3266,   'max': 4.2078,   'zp': 5.432256e-12, 'zp_photon': 1.0164e+01, 'ABtoVega':0, 'ext': 0.06, 'system': 'MKO' },
              "M'":     { 'eff': 4.66443,  'min': 4.4965,   'max': 4.8650,   'zp': 2.251348e-12, 'zp_photon': 5.3049e+00, 'ABtoVega':0, 'ext': 0.05, 'system': 'MKO' },
